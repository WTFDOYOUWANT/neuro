...
function goToSlide(n) {
    ...
    previous_slide.src = 'static/img/gallery/examples/' + (previousSlideId) + '.jpeg';

    let background = document.getElementById('background-image');
    background.style = 'background-image: url(static/img/gallery/examples/back_' + (currentSlideId) + '.jpeg);';

    let current_slide = document.getElementById('current_slide');
    current_slide.src = 'static/img/gallery/examples/' + (currentSlideId) + '.jpeg';
